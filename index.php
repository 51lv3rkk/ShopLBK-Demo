...
<header class="header">
    ...
    <a href="#home" class="logo"> LBK </a>

    <form action="" class="search-form">
        <input type="search" name="" placeholder="tên, mã sản phẩm..." id="search-box">
...
<section class="home" id="home">
    ...
    <div class="slide active">
        <div class="content">
            ...
            <span>Sản phẩm mới nhất 2023</span>
            <h3>Son môi</h3>
...
<section class="about" id="about">
    ...
    <div class="content">
        <span>Tại sao chọn sản phẩm của chúng tôi?</span>
...
<section class="team" id="team">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Mai Lê Bảo Khánh</h3>
                <p>Mã sinh viên: 70DCTM23001</p>
            </div>
        </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-envelope"></i> 1610mailebaokhanh2001@gmail.com </p>
            <p> <i class="fas fa-map"></i> Hà Nội, Việt Nam </p>
            <div class="share">
                <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-twitter"></a>
                <a href="#" class="fab fa-instagram"></a>
        ...
        <div class="box">
            <h3>Đăng ký ngay</h3>
            <p>Nhận thông báo về sản phẩm mới nhất</p>
            <form action="">
                <input type="email" name="" placeholder="Nhập email của bạn..." id="" class="email">
    ...
    <div class="credit"> Sản phẩm đồ án cá nhân | <span>Mai Lê Bảo Khánh</span> | MSV: 70DCTM23001 <a href="./admin/">Admin</a></div>
